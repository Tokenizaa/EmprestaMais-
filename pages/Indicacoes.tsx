...
export const Indicacoes: React.FC = () => {
  ...
  const referralLink = `https://credifacil.app/registro?ref=${user?.id}`;
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    try {
        await supabaseService.db.createIndication(user.id, formData);
    ...
    <div className="space-y-8">
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-violet-600 to-indigo-600 p-8 text-white shadow-xl">
         <div className="relative z-10 max-w-xl">
            ...
            <p className="text-indigo-100 text-lg mb-6">Convide amigos para a CrediFacil. Ganhe <span className="font-bold text-amber-300">100 XP</span> para cada amigo que tiver um empréstimo aprovado.</p>
